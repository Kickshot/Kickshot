Shader "Unlit/Cloud"
{
	...
	SubShader
	{
		...
		void disp(inout appdata_full v, out Input o)
		{
			...
			float3 worldNormalS = saturate(pow(worldSpaceNormal * 1.4, 4)); //correct blend value
			...
			o.noiseComb = noiseXY; //combine texture sides
		...
		void surf(Input IN, inout SurfaceOutput o ) {
			...
			o.Emission = _RimColor.rgb * pow(rim, _RimPower); //add glow rimlight to Cloud
